...
//修改
    ...
    public  Result updateOne(@RequestBody StudentDto studentDto){

        int i = studentService.updateSelectiveDto(studentDto);
        if(i==1){
            return new Result();
        }else{
...
public  Result addOne(@RequestBody StudentDto studentDto) {
